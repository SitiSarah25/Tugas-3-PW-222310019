    ...
    <div class="container h-100">
        <div class="d-flex flex-column justify-content-center align-items-center h-100">
            ...
            <div class="card w-100 w-lg-400px">
                <div class="card-body">
                    <form action="<?php echo e(url('sign-in')); ?>" method="post" id="form-sign-in" onsubmit="handleSignIn(event)">
                        <?php echo csrf_field(); ?>
...
<script>
    ...
    const handleSignIn = (event) => {
        ...
        if (email === "") {
            ...
            signInButton.textContent = 'Sign In'; // Mengembalikan teks tombol menjadi "Sign In"
        } else if (password === "") {
            alert("Password Tidak Boleh Kosong!");
            signInButton.textContent = 'Sign In'; // Mengembalikan teks tombol menjadi "Sign In"
        } else {
            if (email === "222310019@student.ibik.ac.id" && password === "222310019") {
                alert("Successfully! \n\nEmail : "+email + "\nPassword : "+password);
                signInButton.textContent = 'Success Sign In'; // Mengubah teks tombol menjadi "Success Sign In"
...
</html><?php /**PATH C:\Users\Asus\Documents\222310019_ProjectPWEB\tugas3\resources\views/Tugas3.blade.php ENDPATH**/ ?>